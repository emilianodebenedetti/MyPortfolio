    ...
    <>
      <button className="card backdrop-blur-md border shadow-xl rounded-none" onClick={() => onSelect(<Project/>)}>
          ...
          <div className="card-body p-4">
            ...
            <p className="text-base text-left">{resumen}</p>
            <div className="card-actions pt-2">
              <button className="btn hover:bg-transparent rounded-none" onClick={() => onSelect(<Project/>)}>
                 Ver detalle
              ...
              <a href={github} target="_blank" rel="noopener noreferrer">
                <button className="btn hover:bg-transparent rounded-none" >Ver código
